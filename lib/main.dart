...
const Color appBackground = Color(0xFFF7F9F9);
const Color appPrimary = Color(0xFF2C3E50);
const Color appAccent = Color(0xFF1ABC9C);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.terminal, color: appAccent),
      ...
      // Lighter, More Transparent Glassmorphism
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: Colors.white
                  .withOpacity(0.55), // Reduced opacity for more transparency
              border: Border(
                  top: BorderSide(
            ...
            child: BottomNavigationBar(
              ...
              items: const [
                BottomNavigationBarItem(
                    icon: Icon(Icons.campaign), label: 'Promos'),
                BottomNavigationBarItem(
                    icon: Icon(Icons.spa), label: 'Facilities'),
                BottomNavigationBarItem(
